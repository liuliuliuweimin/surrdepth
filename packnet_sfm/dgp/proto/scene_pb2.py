...
from packnet_sfm.dgp.proto import sample_pb2 as dgp_dot_proto_dot_sample__pb2
...
Scene = _reflection.GeneratedProtocolMessageType('Scene', (_message.Message,), dict(
  ...
  OntologiesEntry = _reflection.GeneratedProtocolMessageType('OntologiesEntry', (_message.Message,), dict(
...
Scenes = _reflection.GeneratedProtocolMessageType('Scenes', (_message.Message,), dict(
  DESCRIPTOR = _SCENES,
  __module__ = 'dgp.proto.scene_pb2'
...
SceneFiles = _reflection.GeneratedProtocolMessageType('SceneFiles', (_message.Message,), dict(
