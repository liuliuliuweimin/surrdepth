...
from packnet_sfm.dgp.proto import annotations_pb2  # isort:skip
...
from packnet_sfm.dgp.datasets.base_dataset import BaseSceneDataset  # isort:skip
from packnet_sfm.dgp.datasets.synchronized_dataset import (  # isort:skip
