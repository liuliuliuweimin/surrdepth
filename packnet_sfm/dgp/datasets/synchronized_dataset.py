...
from packnet_sfm.dgp.datasets import ANNOTATION_KEY_TO_TYPE_ID
from packnet_sfm.dgp.datasets.annotations import (get_depth_from_point_cloud,
...
from packnet_sfm.dgp.datasets.base_dataset import (BaseSceneDataset, DatasetMetadata,
                                       _BaseDataset)
from packnet_sfm.dgp.utils.geometry import Pose
from packnet_sfm.dgp.utils.ontology import (build_detection_lookup_tables,
...
class SynchronizedSceneDataset(_SynchronizedDataset):
    ...
    def __init__(
        ...
        # print("calibration_table:",calibration_table)
