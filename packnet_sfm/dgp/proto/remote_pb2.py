...
RemotePath = _reflection.GeneratedProtocolMessageType('RemotePath', (_message.Message,), dict(
...
RemoteArtifact = _reflection.GeneratedProtocolMessageType('RemoteArtifact', (_message.Message,), dict(
